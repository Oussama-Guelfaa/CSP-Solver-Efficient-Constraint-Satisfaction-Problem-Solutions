/**
 * SolveNaturalNQueenCSP.java
 *
 * This class solves the N-Queens problem using the brute force approach
 * implemented in NaturalNQueenCSP.java. It tests the performance of both
 ...
 * 1. Creates a NaturalNQueenCSP instance
 ...
 *
 * The results demonstrate that the brute force approach becomes increasingly
 * inefficient as the board size grows, especially with backtracking.
 *
...
/**
 * Solves the N-Queens problem for an increasing number of queens
 * using both backtracking and min-conflicts strategies.
 */
public class SolveNaturalNQueenCSP {

    public static void main(String[] args) {
        System.out.println("Solving N-Queens Problem with Brute Force Approach");
        System.out.println("=================================================");
        ...
        for (int n = 4; n <= 8; n++) {
            ...
            // Create the CSP
            NaturalNQueenCSP queensCSP = new NaturalNQueenCSP(n);
    ...
    private static void printQueensSolution(Assignment solution, int n) {
        ...
        for (Variable var : solution.getVariables()) {
            ChessBoardCell cell = (ChessBoardCell) solution.getAssignment(var);
            if (cell != null) {
                board[cell.getL() - 1][cell.getC() - 1] = 'Q';
            }
        }
